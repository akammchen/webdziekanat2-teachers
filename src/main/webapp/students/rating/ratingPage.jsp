...
<div class="col-sm-3 col-sm-offset-2 text-center">
	<img src="/webdzieknat2/webPics/oceny.jpg" alt="Studenci" class="img-thumbnail">
	</div>
<ul class="pager">
		<li><a href="addRatings.jsp" target="frameStudents">Wstaw ocenê</a>
		</li>
		<li><a href="showRatings.jsp" target="frameStudents">Poka¿ oceny</a></li>
	</ul>
</div>
