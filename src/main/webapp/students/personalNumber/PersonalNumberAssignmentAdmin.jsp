			...
			<div class="col-md-6 col-md-offset-3">
				<div class="well well-sm">
					<form class="form-horizontal"
						action="PersonalNumberAssignmentAdmin.jsp?id_personalNumber=<%=id_personalNumber%>"
						method="post">
						<fieldset>
							...
							<div class="form-group">
								<label class="col-md-3 control-label" for="address">Wybierz
									role systemow±</label>
								<div class="col-md-9">
									<select class="form-control" name="selValue2" id="selValue2">
						...
						<%
							...
							String rola = request.getParameter("selValue2");
								...
								if (student != null) {
									...
									{
									personalNumberToRemove.setIs_administrator("1");
									personalNumberToRemove.setIs_student("0");
									}
									else if (rola.equals("student"))
									{
									personalNumberToRemove.setIs_student("1");
									personalNumberToRemove.setIs_administrator("0");
									}
									else
									{
									personalNumberToRemove.setIs_student("0");
